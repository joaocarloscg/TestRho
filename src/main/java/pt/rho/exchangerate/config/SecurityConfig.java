...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http.authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/rates").hasAuthority(RATES_READ_AUTHORITY)
                        .requestMatchers(HttpMethod.GET, "/api/v1/rates/**").hasAuthority(RATES_READ_AUTHORITY)
                        .requestMatchers(HttpMethod.GET, "/api/v1/conversions/**").hasAuthority(RATES_READ_AUTHORITY)
